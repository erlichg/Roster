...
function HDate(day, month, year) {
    ...
    return me.setLocation(...HDate.defaultLocation);
}
...
Object.defineProperty(HDate, "defaultCity", {
    ...
    get() {
        return cities.nearest(
            HDate.defaultLocation[0],
            HDate.defaultLocation[1]
        );
    },
    set(city) {
...
prototype.getTishreiMonth = function() {
    const nummonths = MONTH_CNT(this[getFullYear]());
...
function abs2hebrew(d) {
    ...
    while (
        d >
        hebrew2abs((hebdate = new HDate(daysInMonth(month, year), month, year)))
    ) {
...
prototype.toString = function(o) {
    return `${c.LANG(
        [this[getDate](), null, gematriya(this[getDate]())],
        o
    )} ${this.getMonthName(o)} ${c.LANG(
        [this[getFullYear](), null, gematriya(this[getFullYear]())],
        o
    )}`;
};
...
prototype.setLocation = function(lat, lon) {
    ...
    if (typeof lon !== "number") {
        throw new TypeError(
            "incorrect long type passed to HDate.setLocation()"
        );
    }
