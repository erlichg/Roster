...
const tMonthLengths = [0, 31, 28, 31].concat(t0t1, t0t1, 31, t0t1, t0t1);

const monthLengths = [tMonthLengths.slice()];
tMonthLengths[2]++;
...
exports.abs2greg = function(theDate) {
    ...
    const d0 = theDate - 1;
    const n400 = floor(d0 / 146097);
    const d1 = floor(d0 % 146097);
    const n100 = floor(d1 / 36524);
    const d2 = d1 % 36524;
    const n4 = floor(d2 / 1461);
    const d3 = d2 % 1461;
